...
const ExpenseForm = (props) => {
    ...
    const titleChangeHandler = (event) => {
        ...
        // This is used when we want to update the state for one of the mentioned states and maintain the states of others.
        // setUserInput({
        //     ...userInput,
        //     enteredTitle: event.target.value,
        // });

        // if you would be managing a counter which you increment by one, for example, 
